...
/// Win32 native dialog for managing the TSF whitelist.
/// Listed apps use the TSF engine; all other apps fall back to the keyboard hook.
/// Modal dialog with ListView + add/delete/import/export + window picker.
class ClassicTsfAppsDialog {
public:
...
private:
    ...
    static constexpr const wchar_t* kClassName = L"VKeyTsfApps";
};
